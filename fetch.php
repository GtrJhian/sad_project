...
EOT;
        ...
        }else if($fetch=='employee'){   
                $table = <<<EOT
                         (
                           SELECT G.agency_name, C.account_principal, E.emp_id,
                            E.emp_lname, E.emp_fname, E.emp_mname,
                            E.emp_status, E.emp_bday,
                            E.emp_man_status, E.emp_endDate, E.emp_dateHired
                            FROM employee_list as E
                            INNER JOIN account_list C ON C.account_id = E.account_id
                            INNER JOIN agency_list G ON G.agency_id = C.agency_id
                         ) temp
EOT;
                ...
                $columns = array(
                    ...
                    array( 'db' => 'emp_bday',    'dt' => 2 ),
                    array( 'db' => 'emp_status',     'dt' => 3 ),
                    array( 'db' => 'emp_endDate',    'dt' => 4 ),
                    array( 'db' => 'agency_name', 'dt' => 5 ),
                    array( 'db' => 'account_principal',  'dt' => 6 ),
                    array( 'db' => 'emp_dateHired',    'dt' => 7 ),
                    array( 'db' => 'emp_man_status',    'dt' => 8 ),
                    array( 'db' => 'emp_id', 'dt' => 9 ),

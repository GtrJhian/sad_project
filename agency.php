...
<div class="body">
    ...
    <table class="table table-hover table-striped " id="agencylist">
        <thead>
        <tr>
            <th>Name</th>
...
<!--ADD AGENCY-->
<div id="addagencymodal" class="modal fade inline" role="dialog">
        ...
        <div class="modal-content">
            ...
            <div id="fields1" class="modal-body">
                ...
                <input name="agency_name" class="form-control" type="text" required><br> 

                <label>General Manager First Name: </label><br>
                <input name="gm_fname" class="form-control" type="text" required><br>
                <label>General Manager Middle Name: </label><br>
                <input name="gm_mname" class="form-control" type="text" ><br>
                <label>General Manager Last Name: </label><br>
                <input name="gm_lname" class="form-control" type="text"required><br>
                            
                <label>E-mail: </label><br>
                <input name="agency_gm_email" class="form-control" type="email" required><br>
                            
                <label>Contact Number: </label><br>
                <input name="agency_contactNumber" class="form-control" type="text" required><br>
